...
file_data = "M:/Usuels.dsc/pRev/FI/cahier_FI/data/2021-08-01_rend_tit-ref-oati_exl.xls"

data = readxl::read_xls(file_data)
data = data[-c(1:5),c(1:4)]
names(data) = c("time","OATi","OAT","Point-mort d'inflation")
